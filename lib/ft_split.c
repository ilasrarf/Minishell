...
/*   Updated: 2023/05/15 15:14:46 by aen-naas         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../minishell.h"

char	*ft_my_strtrim(const char *s1, char set)
{
	int		len_s1;
	char	*str;
...
int	ft_cnt_words(char *str, char c)
{
	int	i;
	int	cnt;
...
char	**ft_append(char **res, char *str, char c, int cnt_w)
{
	int	i;
